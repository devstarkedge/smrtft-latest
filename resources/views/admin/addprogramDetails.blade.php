            ...
            <div class="col-md-6">
                <div class="panel panel-white">
                    <div class="panel-body">
                             ...
                             <form method="POST" action="{{route('admin.trainer.saveprogram.details',$id)}}"   enctype="multipart/form-data">
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <input id="subprogramname" type="text" class="form-control{{ $errors->has('subprogramname') ? ' is-invalid' : '' }}" name="subprogramname" value="" required placeholder="Enter   program Title..">
                                    </div>
                                    <div class="form-group col-sm-12">
                                    ...
                                    <div class="form-group col-sm-12">
                                     ...
                                     <input type="checkbox" value="{{$details->id}}" class="form-control" name="workouts[]">
